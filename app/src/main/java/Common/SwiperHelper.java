...
import Callbacks.ButtonClickListener;
...
public abstract class SwiperHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public class MyButton{
        ...
        public void onDraw(Canvas c,RectF rectF,int position){
            ...
            if(imageResId == 0){ //show text
                ...
                Bitmap bitmap = darableToBitMap(d);
    ...
    private Bitmap darableToBitMap(Drawable d) {
    ...
    private void drawButton(Canvas c, View itemView, List<SwiperHelper.MyButton> buffer, int pos, float translationX) {
